...
function FooterIcon({empty, icon}) {
    return (
        <div className="select-none rounded-xl p-[3px] w-12 h-12  bg-gradient-to-b from-[#4367E8] via-[#A192FF] to-[#A46CEB]">
            <div data-isEmpty={!empty} className="data-[isEmpty=true]:bg-gray-100 w-full h-full rounded-lg flex justify-center items-center">
                <img src={icon} data-isEmpty={!empty} className="w-7 h-7 data-[isEmpty=false]:grayscale data-[isEmpty=false]:brightness-200" alt="logo" />
            </div>
        </div>
    )
}
